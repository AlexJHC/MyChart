import{D as t}from"./database-type-DzFzzfY6.js";import{d as b,D as a,b as N}from"./canvas-utils-DduuDUb8.js";import"./index-erRrosO1.js";import"./label-BqRU9iC8.js";import"./theme-provider-Duo_jK4a.js";import"./databases-DiL8jvE9.js";import"./use-storage-BV5ljb6r.js";const f=(n={})=>{const e=n.databaseEdition,E=`
...
`;return n.databaseClient===N.POSTGRESQL_PSQL?`${u}psql -h HOST_NAME -p PORT -U USER_NAME -d DATABASE_NAME -c "
...
`,g=(n={})=>n.databaseEdition===a.SQLITE_CLOUDFLARE_D1?(n==null?void 0:n.databaseClient)===N.SQLITE_WRANGLER?k():M:y,C=`'""'`,h=`/* SQL Server 2017 and above edition (14.0, 15.0, 16.0, 17.0)*/
WITH fk_info AS (
    SELECT
        JSON_QUERY(
            N'[' + STRING_AGG(
...
) AS metadata_json_to_import;`,F=(n={})=>n.databaseEdition===a.SQL_SERVER_2016_AND_BELOW?U:h,x='""',H=`SET SESSION group_concat_max_len = 10000000;
SELECT CAST(CONCAT(
    '{"fk_info": [',
    IFNULL((SELECT GROUP_CONCAT(
        CONCAT('{"schema":"', cast(fk.table_schema as CHAR),
...
WITH fk_info AS (
    ...
    FROM (
            SELECT c.conname AS foreign_key_name,
                ...
                WHERE
                    c.contype = 'f'
                    AND connamespace::regnamespace::text NOT IN ('information_schema', 'pg_catalog')${S}
    ) AS x
), pk_info AS (
    SELECT array_to_string(array_agg(CONCAT('{"schema":"', replace(schema_name::TEXT, '"', ''), '"',
...
cols AS (
    ...
    SELECT array_to_string(array_agg(CONCAT('{"schema":"', views.schemaname::TEXT,
                      ...
                      ',') AS views_metadata
    FROM pg_views views
    WHERE views.schemaname NOT IN ('information_schema', 'pg_catalog')${W}
)
SELECT CONCAT('{    "fk_info": [', COALESCE(fk_metadata, ''),
                    '], "pk_info": [', COALESCE(pk_metadata, ''),
                    '], "columns": [', COALESCE(cols_metadata, ''),
...
WITH fk_info AS (
	...
	FROM   dual
`,X={[t.GENERIC]:()=>"",[t.POSTGRESQL]:f,[t.MYSQL]:I,[t.SQLITE]:g,[t.SQL_SERVER]:F,[t.MARIADB]:()=>H,[t.CLICKHOUSE]:()=>D,[t.COCKROACHDB]:()=>B,[t.ORACLE]:()=>w};export{X as importMetadataScripts};
